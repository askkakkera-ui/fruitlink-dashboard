  ...
  return (
    <div style={{ padding: isMobile ? '18px 16px 40px' : '24px 28px 40px', background: C.bg, minHeight: '100%' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 14, marginBottom: 18, flexWrap: 'wrap' }}>
        <div>
          <h1 style={{ fontSize: 24, fontWeight: 800, letterSpacing: '-.02em', color: C.text, margin: 0 }}>Attendance</h1>
          <div style={{ fontSize: 13, color: C.text2, marginTop: 4, fontWeight: 600 }}>Field staff check-in / check-out records</div>
        </div>
