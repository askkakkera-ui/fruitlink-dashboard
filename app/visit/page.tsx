              ...
              <Card>
                ...
                {photoPreview ? (
                  <>
                    ...
                    <label style={{ display: 'block', width: '100%', padding: '10px', borderRadius: 9, border: '1px solid ' + C.border, background: C.surface, fontSize: 13, fontWeight: 700, color: C.text2, cursor: 'pointer', marginBottom: 12, textAlign: 'center' as const }}>
                      Retake
